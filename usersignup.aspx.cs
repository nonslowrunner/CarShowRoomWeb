...
namespace ElibraryManament02
{
    ...
    public partial class usersignup : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Write("<script>alert('Member Already Exist with this Membe ID try other ID');</script>");
            }
            else
            {
                signUpNewMember();
        ...
        bool checkMemberExists()
        {
            ...
            SqlCommand cmd = new SqlCommand("SELECT * FROM member_master_tbl where member_id='"+ TextBox11.Text.Trim() + "';", con);
