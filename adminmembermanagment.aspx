<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminmembermanagment.aspx.cs" Inherits="ElibraryManament02.adminmembermanagment" %>
                  ...
                  <div class="card">
                      ...
                      <div class="row">
                          ...
                          <div class="row">
                              <div class="col">
                                  <center>
                                      <img src="imgs/icon/download%20(1).png" width="100px"  />
                                  </center>
                                   ...
                                   <label>Member ID</label>
                                    <div class="form-group">
                                       ...
                                       <asp:TextBox CssClass="form-control" ID="TextBox2" runat="server"
                                        ...
                                        <asp:LinkButton class="btn btn-dark" ID="LinkButton3" 
                                   ...
                                   <label>Account status</label>
                                    <div class="form-group">
                                       ...
                                       <asp:TextBox CssClass="form-control  mr-1" ID="TextBox7" runat="server"
                                            placeholder="Accout Status" ReadOnly="True"> </asp:TextBox>       
                                           
                                       <asp:LinkButton class="btn btn-success mr-1" ID="Button1" 
                                       runat="server"><i class="fas fa-check-circle"></i></asp:LinkButton>
                                   ...
                                   <label>Date of Birth</label>
                                    <div class="form-group">
                                       ...
                                       <asp:TextBox CssClass="form-control" ID="TextBox3" runat="server"
                                            placeholder="Date of Birth"  TextMode="Date" ReadOnly="True"> </asp:TextBox>       
                                ...
                                <div class="col-12">
                                   ...
                                   <div class="row">
                                       <div class="col-8 mx-auto">
                                          <asp:Button ID="Button2" class="btn btn-lg btn-block badge-danger" 
